...
export default function CreateCoursePage() {
    ...
    const handleAddArrayItem = (field: keyof typeof courseData, value: string, setter: React.Dispatch<React.SetStateAction<string>>) => {
        if (value.trim()) {
            setCourseData({
                ...courseData,
    ...
    const handleRemoveArrayItem = (field: keyof typeof courseData, index: number) => {
        setCourseData({
            ...courseData,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSuccess("Course created successfully and synced to Moodle!")
            ...
            <div className="max-w-4xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground mt-2">
                        Create a new course and assign instructors. Course will be synced to Moodle automatically.
                    </p>
                </div>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">Upload a course thumbnail image (optional)</p>
                                </div>
                            </div>

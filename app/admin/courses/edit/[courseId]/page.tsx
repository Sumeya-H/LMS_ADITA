...
export default function EditCoursePage() {
    ...
    const fetchCourseData = async () => {
        try {
            ...
            // Map the API response to your course data structure
            setCourseData({
                id: data.reg_id || data.id || "",
                title: data.title || "",
                ...
                level: data.level || "",
                format: data.format || "",
                price: data.price ? data.price.replace('$', '').replace(',', '') : "", // Remove $ and commas if present
                category: data.type || data.category || "",
                audience: data.audience || [],
                outcomes: data.outcomes || [],
                requirements: data.requirements || [],
                certification: data.certification || "",
                start_dates: data.startDates || data.start_dates || [],

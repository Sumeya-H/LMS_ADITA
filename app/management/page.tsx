...
import { approveManagementRegistration, fetchManagementRegistrations } from "@/services/courseService";
...
export default function ManagementPage() {
    ...
    const loadData = async () => {
        const res = await fetchManagementRegistrations();
        setData(res);
    };

    const handleApprove = async (id: string) => {
        await approveManagementRegistration(id);
        setSelected(null);
        loadData();
    };

...
export default function ProgramDetailPage({ params }) {
  ...
  const program = {
    ...
    longDescription:
      "This program provides a solid foundation in artificial intelligence concepts and techniques. You'll learn the fundamentals of machine learning, neural networks, and data science that form the building blocks of modern AI systems. Through hands-on projects and real-world case studies, you'll develop practical skills that can be applied across various industries.",
    type: "certification",
    duration: "8 weeks",
    level: "Beginner",
    ...
    instructors: [
      {
        ...
        bio: "PhD in Computer Science with 10+ years of experience in AI research and education.",
        image: "/placeholder.svg?height=200&width=200&query=african%20woman%20professor",
      },
      {
        name: "Prof. Emmanuel Osei",
        title: "Data Science Specialist",
        bio: "Former Google AI researcher with expertise in machine learning algorithms.",
    ...
    modules: [
      {
        ...
        duration: "1 week",
        topics: ["History of AI", "Types of AI", "AI applications in Africa", "Ethical considerations"],
      },
      {
      ...
      },
      {
        ...
        duration: "2 weeks",
        topics: ["Perceptrons", "Backpropagation", "Deep learning introduction", "Building simple neural networks"],
      },
      {
        title: "Capstone Project",
        duration: "1 week",
        topics: ["Project planning", "Implementation", "Evaluation", "Presentation"],
      },
    ],
    outcomes: [
  ...
  return (
    <div className="container py-12">
          ...
          <div className="mt-8">
            <Tabs defaultValue="overview">
              ...
              <TabsContent value="reviews" className="mt-6">
                <ProgramReviews programId={params.programId} />
              </TabsContent>
                    ...
                    <Card key={index}>
                      <CardContent className="flex flex-col items-start justify-between p-6 sm:flex-row sm:items-center">
                        ...
                        <Button asChild className="mt-4 sm:mt-0">
                          <Link href={`/programs/${params.programId}/enroll`}>Enroll Now</Link>
                        </Button>
                      </CardContent>
                    </Card>
                  ))}
      ...
      <div className="mt-16">
        <RelatedPrograms currentProgramId={program.id} />
      </div>
    </div>
  )
}
